...
//  convert_distance << from_start_to_the_detector / cm;
  convert_distance << distance / cm;
...
//  this_string_is_distance_from_start_to_layer = convert_distance_fstl.str();
  ...
  convert_cover_sizeZ << cover_sizeZ/ mm;     // insert the textual representation of 'Number' in the characters in the stream
