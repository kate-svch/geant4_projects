...
//positive sign of q_charge corresponds to negative charge above the imaginary conducting_plane
//G4double q_charge = 3*std::pow(10,-6)*coulomb;   // it approximately corresponds to 3 MV for the distance more than 1 m

G4double q_charge = 20*std::pow(10,-6)*coulomb;   // it approximately corresponds to 20 MV for the distance more than 1 m

//extern G4double from_electrode_to_edge_of_the_world;
extern G4double distance;
extern G4double world_sizeZ;

G4double from_electrode_to_edge_of_the_world = distance;
